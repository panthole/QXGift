...
public abstract class ExpandableAdapter<
    ...
    GiftItemView.OnItemSendClick onItemSendClick;

    interface onToggleListener {
        void onToggle(int position, View itemVIew);
    }

    public void setmOnItemSendClickListener(GiftItemView.OnItemSendClick onItemSendClick) {
    ...
    protected abstract void onBindExpandableViewHolder(EVH holder, boolean isExpanded,
                                                       int height, int position,GiftItemView.OnItemSendClick onItemSendClick);
